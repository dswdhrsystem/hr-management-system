                ...
                <div class="col-span-12 md:order-9 lg:col-span-6 lg:row-span-2 xl:col-span-4 xl:row-span-2 2xl:row-span-2 2xl:col-span-3 card">
                    <div class="card-body">
                        ...
                        <div class="flex gap-3 p-2 mt-3 rounded-md bg-custom-500">
                            <div class="shrink-0">
                                <img src="{{ URL::to('assets/images/avatar-6.png') }}" alt="" class="h-24">
                            </div>
                            <div>
                        ...
                        <div data-simplebar="" class="flex flex-col h-[350px] gap-4 px-5">
                            <div class="flex flex-col gap-3">
                                <div class="border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex flex-wrap items-center gap-3 p-2">
                                        <div class="rounded-full size-10 shrink-0">
                                            <img src="{{ URL::to('assets/images/avatar-7.png') }}" alt="" class="h-10 rounded-full">
                                        </div>
                                        <div class="grow">
                                ...
                                <div class="border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex flex-wrap items-center gap-3 p-2">
                                        <div class="rounded-full size-10 shrink-0">
                                            <img src="{{ URL::to('assets/images/avatar-1000.png') }}" alt="" class="h-10 rounded-full">
                                        </div>
                                        <div class="grow">
                                            <h6 class="mb-1"><a href="#!">Jeunile Kim</a></h6>
                                            <p class="text-slate-500 dark:text-zink-200">jeunile@gmail.com</p>
                                        </div>
                                        <div class="relative dropdown shrink-0">
                                ...
                                <div class="border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex flex-wrap items-center gap-3 p-2">
                                        <div class="rounded-full size-10 shrink-0">
                                            <img src="{{ URL::to('assets/images/avatar-9.png') }}" alt="" class="h-10 rounded-full">
                                        </div>
                                        <div class="grow">
                                ...
                                <div class="border rounded-md border-slate-200 dark:border-zink-500">
                                    <div class="flex flex-wrap items-center gap-3 p-2">
                                        ...
                                        <div class="grow">
                                            ...
                                            <p class="text-slate-500 dark:text-zink-200">gladys.smith@gmail.com</p>
                                        </div>
                                        <div class="relative dropdown shrink-0">
